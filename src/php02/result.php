...
<body>
    ...
    <div class="time-difference">
        <div class="time-difference__inner">
            <h2 class="time-d">
                日本との時差は<span class="time-css"><?php echo $comparison['diff'] ?></span> です。</br>
                <?php echo $comparison['name']?>の天気は<span class="time-css"><?php echo $comparison['weather']?></span>です。</br>
                気温：<span class="time-css"><?php echo $comparison['temp']?></span>℃ ／ 湿度：<span class="time-css"><?php echo $comparison['hum']?></span>% ／ 降水確率：<span class="time-css"><?php echo $comparison['rain']?></span>%
            </h2>
        </div>
    </div>
</body>
